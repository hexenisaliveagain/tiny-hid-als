...
// Correction factor used to calculate lux multiplied by 10. 
// Typical value is 1.2 but can range from 0.96 to 1.44. 
// See the data sheet (p.2, Measurement Accuracy) for more information.
#define BH1750_CONV_FACTOR 12;
